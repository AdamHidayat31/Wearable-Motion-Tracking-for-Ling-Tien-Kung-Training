...
const navItems = [
  { href: "/user/halaman-latihan", icon: "lucide:activity" },
  { href: "/user/koneksi-perangkat", icon: "lucide:activity" },
  { href: "/user/riwayat-latihan", icon: "lucide:history" },
  { href: "/user/profil", icon: "lucide:user" },
];
